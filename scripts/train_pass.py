...
@hydra.main(version_base=None, config_path=CONFIG_PATH, config_name="train_pass")
def main(cfg: DictConfig):
    ...
    policy = algos[cfg.algo.name.lower()](
        cfg.algo, agent_spec_dict=agent_spec_dict, mask_name=cfg.task.policy_start_time, device="cuda"
    )
