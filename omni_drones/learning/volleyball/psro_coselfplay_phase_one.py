...
from omni_drones.learning import MAPPOPolicy, PSROPolicy, PSROPolicy2, MAPPOPolicy_mask, MAPPOPolicy_mask_KL


class PSROPolicy_coselfplay_phase_one(object):
    ...
    def __init__(self, cfg, agent_spec_dict: Dict[str, AgentSpec], device, num_envs) -> None:
        ...
        self.policy_SecPass = MAPPOPolicy_mask_KL(cfg=cfg, agent_spec=SecPass_agent_spec, device=device, mask_name=('stats', 'SecPass_train_flag'))
