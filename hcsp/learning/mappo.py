...
class MAPPOPolicy_SecPass_new(MAPPOPolicy):
    def __init__(self, cfg, agent_spec: AgentSpec, device="cuda") -> None:
        ...
        self.obs_name = ("agents", "SecPass_observation")
        self.state_name = ("agents", "SecPass_state")
        self.act_name = ("agents", "SecPass_new_action")
        self.reward_name = ("agents", "SecPass_reward")
